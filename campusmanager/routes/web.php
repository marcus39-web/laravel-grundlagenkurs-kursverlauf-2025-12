...
// Routen für das Projekt Campus Manager
...
// Diese eine Zeile ersetzt alle obigen Routen für Studenten

//Route::resource('courses', CoursesController::class);

Route::resource('courses', CoursesController::class)->except(['show']);
// Diese eine Zeile ersetzt alle Routen für Kurse außer "show"
